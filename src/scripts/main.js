...
const dataThemeItem = body.getAttribute('data-theme')
const localThemeItem = localStorage.getItem("theme")
if(dataThemeItem == '' && localThemeItem == ''){
  body.setAttribute('data-theme', 'dark')
  localStorage.setItem("theme", 'dark')
}
else if(dataThemeItem == '' && localThemeItem == 'dark'){
  body.setAttribute('data-theme', 'dark')
  localStorage.setItem("theme", 'dark')
}
else if(dataThemeItem == '' && localThemeItem == 'light'){
  body.setAttribute('data-theme', 'light')
  localStorage.setItem("theme", 'light')
}
